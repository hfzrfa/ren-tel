...
<section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-16">
        ...
        <div class="relative z-10 grid items-center gap-6 md:grid-cols-2">
            <div>
                ...
                <p class="mt-2 text-sm text-indigo-100">Reserve your vehicle in under two minutes and cancel for
                    free up to 24h before pickup.</p>
            </div>
        ...
        <div class="pointer-events-none absolute -bottom-12 -left-12 h-60 w-60 rounded-full bg-indigo-300/10 blur-2xl">
        </div>
    </div>
</section>
