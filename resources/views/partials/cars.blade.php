  ...
  <div id="carsGrid" class="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <article
        ...
        <div class="p-4">
          ...
          <ul class="mt-3 flex flex-wrap items-center gap-2 text-[11px] text-gray-600 dark:text-gray-300">
            ...
            <li class="inline-flex items-center gap-1 rounded-md bg-gray-100 px-2 py-1 ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
              <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M5 12l5-5 5 5" /><path d="M12 19V7" />
              </svg>
    ...
    @empty
      <div class="sm:col-span-2 lg:col-span-3">
        <div class="rounded-xl border border-gray-200 bg-white p-6 text-center text-sm text-gray-600 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
