...
function BenefitsGrid() {
  ...
  return (
    <section id="benefits" className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-16">
      <div className="grid gap-8 md:grid-cols-4">
        {items.map((it, i) => (
          <SpotlightCard key={i} className="bg-neutral-900/90 border-neutral-800">
            <Benefit title={it.title} desc={it.desc} icon={it.icon} />
          </SpotlightCard>
        ))}
      </div>
    </section>
