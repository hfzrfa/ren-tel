...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // Separate connection for admin users (can point to another database).
        // By default, falls back to the same credentials as the main MySQL connection.
        'mysql_admin' => [
            'driver' => 'mysql',
            ...
            'unix_socket' => env('DB_ADMIN_SOCKET', env('DB_SOCKET', '')),
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('ADMIN_MYSQL_ATTR_SSL_CA', env('MYSQL_ATTR_SSL_CA')),
            ]) : [],
        ],
