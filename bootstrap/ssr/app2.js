    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          style: { height: panelHeight, ...offsetBottom != null ? { bottom: offsetBottom } : {} },
          role: "toolbar",
...
function Benefit({ title, desc, icon }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsx("div", { className: "mb-3 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600/10 text-indigo-400", children: icon }),
...
function ShieldIcon() {
  return /* @__PURE__ */ jsx("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: /* @__PURE__ */ jsx("path", { d: "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" }) });
}
function CheckIcon() {
  return /* @__PURE__ */ jsx("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: /* @__PURE__ */ jsx("path", { d: "M5 13l4 4L19 7" }) });
}
function GridIcon() {
  return /* @__PURE__ */ jsx("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: /* @__PURE__ */ jsx("path", { d: "M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z" }) });
}
function BoltIcon() {
  return /* @__PURE__ */ jsx("svg", { className: "h-5 w-5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true, children: /* @__PURE__ */ jsx("path", { d: "M22 12h-4l-3 9L9 3 6 12H2" }) });
}
function BenefitsGrid() {
  ...
  return /* @__PURE__ */ jsx("section", { id: "benefits", className: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-16", children: /* @__PURE__ */ jsx("div", { className: "grid gap-8 md:grid-cols-4", children: items.map((it, i) => /* @__PURE__ */ jsx(SpotlightCard, { className: "bg-neutral-900/90 border-neutral-800", children: /* @__PURE__ */ jsx(Benefit, { title: it.title, desc: it.desc, icon: it.icon }) }, i)) }) });
}
...
function NLCalendarInput({ id, label, value, setValue, date, setDate, minDate }) {
  const [open, setOpen] = useState(false);
  const [month, setMonth] = useState(date);
  const disabled = (d) => {
    const today = /* @__PURE__ */ new Date();
    today.setHours(0, 0, 0, 0);
    if (minDate) return d < today || d < minDate;
    return d < today;
  };
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxs(Label, { htmlFor: id, className: "px-1 text-slate-200", children: [
      label,
      " ",
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsx(
        Input,
        {
          ...
          className: "rounded-2xl border border-slate-800/60 bg-slate-900/60 pr-10 text-slate-100",
          onChange: (e) => {
      ...
      /* @__PURE__ */ jsxs(Popover, { open, onOpenChange: setOpen, children: [
        ...
        /* @__PURE__ */ jsx(
          PopoverContent,
          {
            className: "w-auto overflow-hidden p-0 bg-slate-900 text-slate-100 border border-slate-800/60",
            align: "end",
            children: /* @__PURE__ */ jsx(
              Calendar,
              {
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-1 text-sm text-slate-400", children: [
      "Selected: ",
      /* @__PURE__ */ jsx("span", { className: "font-medium text-slate-200", children: formatLong(date) })
    ] })
  ] });
}
function DatePickers({ pickupName = "pickup_date", returnName = "return_date" }) {
  const [pickup, setPickup] = useState(null);
  const [ret, setRet] = useState(null);
  const [pickupText, setPickupText] = useState("");
  const [retText, setRetText] = useState("");
  useEffect(() => {
    const p = document.querySelector(`input[name="${pickupName}"]`);
    const r = document.querySelector(`input[name="${returnName}"]`);
    if (p?.value) setPickup(new Date(p.value));
    if (r?.value) setRet(new Date(r.value));
  }, []);
  useEffect(() => {
    const p = document.querySelector(`input[name="${pickupName}"]`);
    const r = document.querySelector(`input[name="${returnName}"]`);
    if (p) {
      p.value = toYMD(pickup);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
    /* @__PURE__ */ jsx(
      NLCalendarInput,
      {
        id: "pickup-nl",
...
if (mount) {
  createRoot(mount).render(/* @__PURE__ */ jsx(DatePickers, {}));
}
